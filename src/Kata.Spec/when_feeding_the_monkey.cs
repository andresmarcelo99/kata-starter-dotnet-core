...
namespace Kata.Spec
{
    ...
    public class when_the_input_is_a_single_number
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };

        Because of = () => { _result = _systemUnderTest.Add("3"); };

        It should_return_number = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_input_is_two_number
    {
        Establish _context = () => { _systemUnderTest = new Calculator();  };
    ...
    public class when_input_is_numbers_with_new_line_and_commas
    {
        Establish _context = () => { _systemUnderTest = new Calculator();  };
    ...
    public class when_input_has_negative
    {
        ...
        Because of = () => { _result = Catch.Exception(()=>_systemUnderTest.Add("1,-4,3")); };

        It should_throw_exception = () => { _result.Message.Should().Be("negatives not allowed: -4"); };
        static Calculator _systemUnderTest;
    ...
    public class when_input_has_multiple_negatives
    {
        ...
        Because of = () => { _result = Catch.Exception(()=>_systemUnderTest.Add("1,-4,3,-2,-1")); };

        It should_throw_exception = () => { _result.Message.Should().Be("negatives not allowed: -4, -2, -1"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    }
